module.exports = () => {
  ...
  this.ledSpecial = function ledSpecial(bright = config.led.brightness, mode, arg) {
  ...
  this.ledColorMan = function ledColorMan(bright = config.led.brightness, r, g, b) {
    strip.setBrightness(parseInt(bright))
  ...
  this.ledColor = function ledColor(bright = config.led.brightness, color) {
    strip.setBrightness(parseInt(bright))
  ...
  this.ledRainbow = function ledRainbow(iterations) {
  ...
  this.ledRider = function ledRider(color, wait_ms) {
